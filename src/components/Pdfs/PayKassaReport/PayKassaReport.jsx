    ...
    const blob = await pdf(
      <Document>
        <Page size="A5" orientation="landscape" style={styles.page}>
          <PdfFiles pdfData={pdfData} dataSave={dataSave} />
        </Page>
      </Document>
    )?.toBlob();
...
export default PayKassaReport;

const PdfFiles = ({ pdfData, dataSave }) => {
  return (
    <>
      <View style={styles.left}>
        ...
        <View style={styles.code}>
          <View style={{ display: "flex", alignItems: "flex-end" }}>
            ...
            <View style={[]}>
              <Text style={[styles.middleText, styles.form]}>
                ____________________________________________________________ по
                ОКНО
              </Text>
            </View>
            <View style={[]}>
        ...
        <View style={styles.leftTitle}>
          ...
          <View style={styles.table}>
            ...
            <View style={styles.tableRow}>
              <View style={[styles.tableCol, { width: 60, height: 25 }]}></View>
              <View style={[styles.tableCol, { width: 60, height: 25 }]}></View>
            </View>
          </View>
        </View>
        ...
        <View style={styles.table}>
          <View style={styles.tableRow}>
            ...
            <View style={[styles.tableCol]}>
              <Text style={[styles.textTitle]}>код аналити ческого учёта</Text>
            </View>
            <View style={[styles.tableCol]}>
          ...
          <View style={styles.moreTable}>
            <Text style={[styles.textTitle, , { paddingTop: 3 }]}>Кредит</Text>
          </View>
        </View>
        ...
        <View style={styles.flexLines}>
          ...
          <View style={styles.line}>
            <Text style={styles.textSmall}>{dataSave?.fio}</Text>
          </View>
        </View>
        <View style={styles.flexLines}>
      ...
      <View style={styles.right}>
        ...
        <View style={styles.rightInner}>
          ...
          <Text style={[styles.textSmall]}>Принято от {dataSave?.fio}</Text>
          <Text style={styles.textSmall}>________________________________</Text>
          ...
          <Text style={styles.textSmall}>________________________________</Text>
          <Text style={styles.textSmall}>________________________________</Text>
          <Text style={styles.textSmall}>В том числе ___________________</Text>
          <Text style={styles.textSmall}>
          ...
          <Text style={styles.textSmall}>Кассир ________ ________________</Text>
          <View style={styles.bottomText}>
            <Text style={[styles.textMini]}>подпись</Text>
            <Text style={[styles.textMini]}>расшифровка</Text>
          </View>
